...
const ShowEventPopup = ({open, handleClose, event, renderStatus, rerender}) => {
  ...
  const updateEvent = async(e) => {
    e.preventDefault();
    await axios.delete(`https://timetable-backend-ce8b1adf3cf0.herokuapp.com/api/events/${event.id}/delete`)
    await axios.post(`https://timetable-backend-ce8b1adf3cf0.herokuapp.com/api/events/`, createForm);
    handleClose();
